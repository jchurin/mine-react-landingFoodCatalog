export const HEADER_ITEMS = {
    ABOUT: { title: "about", linkTo: "about" },
    PRICING: { title: "pricing", linkTo: "pricing" },
    GPTE: { title: "gpte", linkTo: "great-place-to-enjoy" },
    BEER: { title: "beer", linkTo: "beer" },
    BREAKFAST: { title: "breakfast", linkTo: "breakfast" },
