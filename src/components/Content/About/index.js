    ...
    render() {
        return (
            <section id="about" className="about">
                <img src={require('../../../assets/images/icons/about_color.png')} className="img-responsive section-icon hidden-sm hidden-xs" />
                <div className="wrapper">
                    <div className="container-fluid">
                        <div className="row dis-table">
                            <div className="hidden-xs col-sm-6 section-bg about-bg dis-table-cell"></div>
